...
export default function App() {
  ...
  async function registerForPushNotificationsAsync() {
    ...
    if (Constants.isDevice) { // Changed Device.isDevice to Constants.isDevice
      ...
      token = await Notifications.getExpoPushTokenAsync({
        projectId: Constants.manifest.extra.eas.projectId, // Changed Constants.expoConfig.extra.eas.projectId to Constants.manifest.extra.eas.projectId
      });
      console.log(token);
    } else {
